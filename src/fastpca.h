...
//	PRE_FUNC void rpcgrid2 (double *px, int *pnParams, double *pObj, double *pLoadings, double *pScores) ;
...
//	PRE_FUNC void prcomp_rob (double *pdData, int *pnParams, double *pdS, double *pdV, double *pdScores) ;
//	PRE_FUNC void pcagridc (double *px, int *pnParams, double *pObj, double *pLoadings, double *pScores) ;
...
//	PRE_FUNC void rpclinc (double *pdy, int *pnParams, double *pdScores, double *pdVeig, double *pdLambda) ;
